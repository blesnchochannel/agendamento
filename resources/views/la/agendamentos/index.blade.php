...
@section("contentheader_description", "Agendamentos listing")
@section("section", "Agendamentos")
@section("sub_section", "Listing")
@section("htmlheader_title", "Agendamentos Listing")

@section("headerElems")
@la_access("Agendamentos", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Agendamento</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Agendamento</h4>
			</div>
