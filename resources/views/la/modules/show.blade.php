...
@section('htmlheader_title', 'Visualização de Módulos')
...
<div id="page-content" class="profile2">
	...
	@endif
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="row stats">
						<div class="col-md-12">Quantidade de Itens: {{ Module::itemCount($module->name) }}</div>
					</div>
					<p class="desc">@if(isset($module->is_gen) && $module->is_gen) <div class="label2 success">O módulo foi gerado</div> @else <div class="label2 danger" style="border:solid 1px #FFF;">O módulo não está gerado</div> @endif</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-4">
			@if($module->view_col != "")
				@if(isset($module->is_gen) && $module->is_gen)
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Update Module" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_update" href="#"><i class="fa fa-refresh"></i> Atualizar Módulo</a></div>
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Update Migration File" class="btn btn-sm btn-success" style="border-color:#FFF;" id="update_migr" href="#"><i class="fa fa-database"></i> Atualizar Migração</a></div>
				@else
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Generate Migration + CRUD + Module" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_migr_crud" href="#"><i class="fa fa-cube"></i> Gerar Migração + CRUD</a></div>
					
 					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Generate Migration File" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_migr" href="#"><i class="fa fa-database"></i> Gerar Migração</a></div>
				@endif
			@else
				<div class="dats1 text-center">Para gerar a Migração ou o CRUD, defina um campo de visão ao clicar no ícone <i class='fa fa-eye'></i> nas ações do campo</div>
			@endif
		</div>
	...
	<ul id="module-tabs" data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		...
		<li class="tab-pane" id="access">
			<a id="tab_access" role="tab" data-toggle="tab"  class="tab_info " href="#access" data-target="#tab-access"><i class="fa fa-key"></i> Acesso</a>
		</li>
		
		<li class="tab-pane" id="sort">
			<a id="tab_sort" role="tab" data-toggle="tab"  class="tab_info " href="#sort" data-target="#tab-sort"><i class="fa fa-sort"></i> Ordenação</a>
		</li>
		
		<a data-toggle="modal" data-target="#AddFieldModal" class="btn btn-success btn-sm pull-right btn-add-field" style="margin-top:10px;margin-right:10px;">Adicionar Campo</a>
	</ul>
	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access">
			<div class="guide1">
				<span class="pull-left">Regras de acesso ao módulo</span>
				<i class="fa fa-circle gray"></i> Invisível <i class="fa fa-circle orange"></i> Somente Leitura <i class="fa fa-circle green"></i> Escrita
			</div>
				...
				<table class="table table-bordered dataTable no-footer table-access">
					<thead>
						<tr class="blockHeader">
							<th width="14%">
								<input class="alignTop" type="checkbox" id="role_select_all" >&nbsp; Regras
							</th>
							<th width="14%">
								<input type="checkbox" id="view_all" >&nbsp; Ver
							</th>
							<th width="14%">
							...
							<th width="14%">
								<input class="alignTop" type="checkbox" id="delete_all" >&nbsp; Apagar
							</th>
							<th width="14%">Privilégios por Campo</th>
						</tr>
					</thead>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Adicionar campo no {{ $module->model }}</h4>
			</div>
				...
				<div class="box-body">
					...
					<div id="length_div">
						<div class="form-group">
							...
							{{ Form::number("minlength", null, ['class'=>'form-control', 'placeholder'=>'Valor Mínimo (0 a 250)']) }}
						</div>
						
						<div class="form-group">
							<label for="maxlength">Tamanho Máximo :</label>
							{{ Form::number("maxlength", null, ['class'=>'form-control', 'placeholder'=>'Valor Máximo (0 a 250)']) }}
						</div>
					</div>
					...
					<div class="form-group values">
						...
						<select id="popup_vals_list" class="form-control popup_vals_list" rel="taginput" multiple="1" data-placeholder="Adicione Múltiplos Valores (Pressione Enter para adicionar)" name="popup_vals_list[]">
