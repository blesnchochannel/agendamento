...
@section("contentheader_title", "Atendimentos")
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Adicionar Atendimento</h4>
			</div>
			{!! Form::open(['action' => 'LA\AtendimentosController@store', 'id' => 'atendimento-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/atendimento_dt_ajax') }}",
		language: {
