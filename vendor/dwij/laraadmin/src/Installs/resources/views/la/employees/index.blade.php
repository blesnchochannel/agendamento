...
@section("contentheader_description", "Listagem de employees")
@section("section", "Employees")
@section("sub_section", "Listagem")
@section("htmlheader_title", "Listadem de Employees")

@section("headerElems")
@la_access("Employees", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Adicionar  Employee</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Adicionar Employee</h4>
			</div>
