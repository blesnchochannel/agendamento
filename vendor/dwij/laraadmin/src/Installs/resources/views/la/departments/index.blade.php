...
@section("contentheader_description", "Listagem de departments")
@section("section", "Departments")
@section("sub_section", "Listagem")
@section("htmlheader_title", "Listadem de Departments")

@section("headerElems")
@la_access("Departments", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Adicionar  Department</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Adicionar Department</h4>
			</div>
