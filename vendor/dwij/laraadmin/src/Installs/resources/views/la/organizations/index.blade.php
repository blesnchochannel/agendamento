...
@section("contentheader_description", "Listagem de organizations")
@section("section", "Organizations")
@section("sub_section", "Listagem")
@section("htmlheader_title", "Listadem de Organizations")

@section("headerElems")
@la_access("Organizations", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Adicionar  Organization</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Adicionar Organization</h4>
			</div>
