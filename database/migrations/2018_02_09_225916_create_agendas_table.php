...
class CreateAgendasTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Agendas", 'agendas', 'nome', 'fa-calendar-o', [
            ["nome", "Nome da Agenda", "Name", true, "", 0, 256, true],
            ["aplicador", "Aplicador", "Dropdown", false, "", 0, 0, true, "@users"],
            ["agendamentos", "Agendamentos", "Dropdown", false, "", 0, 0, true, "@agendamentos"],
        ]);
